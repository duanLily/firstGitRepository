...
public class AccountController {
	...
	public String editUserPage(@RequestParam int userId, ModelMap modelMap) {
		...
		List<Department> departments = Optional.ofNullable(organizationService.getDepartments())
		...
		modelMap.addAttribute("positions", organizationService.getPositionsByDepartId(departId));
